...
class TeXExample {
  ...
  _teXViewWidget(r"""<h4>Flutter Assignment</h4>""", r""" 
             
      <p>This assignment will render so many types of equations based on \( \rm\LaTeX \).</p>
      """);
    ...
    return Scaffold(
      ...
      body: TeXView(
        ...
        child: TeXViewColumn(children: [
          ...
          TeXExample.matrix,
          TeXViewDetails(
            title: "Click here to view matrix",
